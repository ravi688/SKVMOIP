...
BUILD_DEFINES= -DUSE_PERSISTENT_SETTINGS -DUSE_VULKAN_PRESENTATION -DUSE_VULKAN_FOR_COLOR_SPACE_CONVERSION -DUSE_DIRECT_FRAME_DATA_COPY
...
ifeq ($(BUILD),server)
	...
	MAIN_SOURCES+=source/main.server.cpp
endif
ifeq ($(BUILD),client)
	...
	MAIN_SOURCES+=source/main.client.cpp
endif
ifeq ($(BUILD),guitest)
	...
	MAIN_SOURCES+=source/main.guitest.cpp
endif
ifeq ($(BUILD),)
...
DEPENDENCIES = PlayVk Common Common/dependencies/BufferLib Common/dependencies/BufferLib/dependencies/CallTrace
DEPENDENCY_LIBS = PlayVk/lib/playvk.a Common/lib/common.a Common/dependencies/BufferLib/lib/bufferlib.a Common/dependencies/BufferLib/dependencies/CallTrace/lib/calltrace.a
...
bin-clean:
	...
	$(MAKE) --directory=./dependencies/PlayVk clean
